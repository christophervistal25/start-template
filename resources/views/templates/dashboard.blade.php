      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  src="{{ url("storage/profile_images/" . Auth::user()->profile_image) }}"
                  >
                </a>
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                  ...
                  <a class="dropdown-item" href="{{route('account.activities')}}">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <h5 class="h5 mb-4 text-gray-800 text-capitalize">@yield('title')</h5>
            @yield('content')
          </div>
          <!-- /.container-fluid -->
        </div>
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; Seledas Apartelle {{date('Y')}}</span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
